function [MatGrav] = PlotEtabsGravity(WallTotalAGrav,PiersAGrav,linetypes,SF)
...
etabsgraphFormat(1)
title('Wall Total');
MatGrav = [-WallTotalAGrav.Walls.Live.WallTotal(:,2)/1000^2 -WallTotalAGrav.Walls.Dead.WallTotal(:,2)/1000^2];
%%
subplot(1,4,2);
...
etabsgraphFormat(0)
title('W1');
MatGrav = [MatGrav -PiersAGrav.Walls.Live.W1(:,2)/1000^2 -PiersAGrav.Walls.Dead.W1(:,2)/1000^2];
%%
subplot(1,4,3);
...
title('W2');
MatGrav = [MatGrav -PiersAGrav.Walls.Live.W2(:,2)/1000^2 -PiersAGrav.Walls.Dead.W2(:,2)/1000^2];
%%
subplot(1,4,4);
...
legend('Dead','Live')
MatGrav = [MatGrav -PiersAGrav.Walls.Live.W3(:,2)/1000^2 -PiersAGrav.Walls.Dead.W3(:,2)/1000^2];